...
public class CharSequenceDemo1 implements CharSequence {
    private String s;

    public CharSequenceDemo1(String s) {
    ...
    public static void main(String[] args) {
        CharSequenceDemo1 s =
            new CharSequenceDemo1("Write a class that implements the CharSequence interface found in the java.lang package.");
