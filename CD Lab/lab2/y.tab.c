...
static const char *const yytname[] =
{
  ...
  "MAIN", "EMPTY_LISTVAR", "STMT", "STMT_NO_BLOCK", "BLOCK", YY_NULLPTR
};
...
#line 1322 "y.tab.c"
  ...
  case 12: /* TYPE: T_INT  */
#line 69 "parser.y"
             { type = INT; size = (int)sizeof(int); }
#line 1328 "y.tab.c"
    break;

  case 13: /* TYPE: T_FLOAT  */
#line 70 "parser.y"
                 { type = FLOAT; size = (int)sizeof(float); }
#line 1334 "y.tab.c"
    break;

  case 14: /* TYPE: T_DOUBLE  */
#line 71 "parser.y"
                  { type = DOUBLE; size = (int)sizeof(double); }
#line 1340 "y.tab.c"
    break;

  case 15: /* TYPE: T_CHAR  */
#line 72 "parser.y"
                { type = CHAR; size = (int)sizeof(char); }
#line 1346 "y.tab.c"
    break;
